defmodule HomepageWeb.CoreComponents do
  ...
  use Gettext, backend: HomepageWeb.Gettext
  ...
  def clutch_testimonials_widget(assigns) do
    ~H"""
  ...
  def clutch_square_widget(assigns) do
    ~H"""
    <script type="text/javascript" src="https://widget.clutch.co/static/js/widget.js">
    </script>
  ...
  def brand_banner(assigns) do
    ...
    <div class="mx-auto max-w-2xl lg:text-center font-mono">
      <h2 class="text-base/7 font-semibold text-black font-mono">for AI first companies</h2>
      ...
      <p class="mt-6 text-lg/8 text-black font-semibold font-mono">
  ...
  def site_socials(assigns) do
    ...
    <div class="mt-16 flex justify-center gap-x-10">
      <a href={Homepage.HomepageData.social_links().twitter} class="text-gray-600 hover:text-gray-800">
        <span class="sr-only">X</span>
        <svg class="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M13.6823 10.6218L20.2391 3H18.6854L12.9921 9.61788L8.44486 3H3.2002L10.0765 13.0074L3.2002 21H4.75404L10.7663 14.0113L15.5685 21H20.8131L13.6819 10.6218H13.6823ZM11.5541 13.0956L10.8574 12.0991L5.31391 4.16971H7.70053L12.1742 10.5689L12.8709 11.5655L18.6861 19.8835H16.2995L11.5541 13.096V13.0956Z" />
        </svg>
      </a>
      <a href={Homepage.HomepageData.social_links().github} class="text-gray-600 hover:text-gray-800">
